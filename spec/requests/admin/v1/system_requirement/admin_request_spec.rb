...
RSpec.describe "Admin::V1::SystemRequirement as admin", type: :request do
  ...
  context "POST /system_requirements" do
    ...
    context "with valid params" do
      ...
      it "return last system_requirement" do
        post url, headers: auth_header(user), params: system_requirement_params
        expected_system_requirement = SystemRequirement.last.as_json(only: %i(name operational_system storage processor memory video_board))
  ...
  context "PATCH /system_requirements/:id" do
    ...
    context "with valid params" do
      ...
      let(:system_requirement_params) { { name: new_name }.to_json }
      
      it 'updates new name system_requirement ' do
    ...
    context "with invalid params" do
      ...
      it 'does not updates system_requirement' do
